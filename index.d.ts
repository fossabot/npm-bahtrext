...
export declare function ABT(num: string | number, ed?: boolean, neg?: boolean): string | undefined;
...
export declare function NEG(num: string, ed?: boolean, neg?: boolean): string | undefined;

export declare class BR {
  constructor(num: string | number, ed?: boolean);
